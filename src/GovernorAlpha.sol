...
contract GovernorAlpha {
    ...
    /// @notice The address of the Tollfree Protocol Timelock
    ...
    constructor(address timelock_, address voterRegistry_ , address toll_) public {
    ...
    function quorumVotes() public view returns (uint) {
        return onePercent(toll.totalSupply()).mul(4);
    } // 4% of Toll
